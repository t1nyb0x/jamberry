...
func TestValidateInput_ValidURL(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "URL with intl-ja locale prefix",
			input:        "https://open.spotify.com/intl-ja/track/0ebT5FWoZX0krQyJKF4XBO?si=324aaa37550446cd",
			expectedType: EntityTrack,
			wantValid:    true,
			wantURL:      "https://open.spotify.com/track/0ebT5FWoZX0krQyJKF4XBO",
			wantID:       "0ebT5FWoZX0krQyJKF4XBO",
		},
		{
			name:         "URL with intl-de locale prefix for artist",
			input:        "https://open.spotify.com/intl-de/artist/0OdUWJ0sBjDrqHygGUXeCF",
			expectedType: EntityArtist,
			wantValid:    true,
			wantURL:      "https://open.spotify.com/artist/0OdUWJ0sBjDrqHygGUXeCF",
			wantID:       "0OdUWJ0sBjDrqHygGUXeCF",
		...
		{
			name:         "URL with intl-fr locale prefix for album",
			input:        "https://open.spotify.com/intl-fr/album/4aawyAB9vmqN3uQ7FjRGTy",
			expectedType: EntityAlbum,
			wantValid:    true,
			wantURL:      "https://open.spotify.com/album/4aawyAB9vmqN3uQ7FjRGTy",
			wantID:       "4aawyAB9vmqN3uQ7FjRGTy",
