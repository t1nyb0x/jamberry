...
`/jam recommend` コマンドでは、以下のモードを選択できます：

| モード     | 説明                                          |
| ---------- | --------------------------------------------- |
| バランス   | 雰囲気と関連性の両方を考慮（デフォルト）      |
| 雰囲気重視 | Deezer 特徴量（BPM/音圧）を重視した類似曲検索 |
| 関連性重視 | MusicBrainz タグ・アーティスト関連を重視      |
...
- Last.fm API Key（recommend コマンドに必須）
...
| `LASTFM_API_KEY`        | Last.fm API Key（recommend コマンドに必須） | ✅               |
